...
class batt {
	...
	void barpos2(int,char,int&,int&,int[][10],int[],int&,int&,int&,int&);
	void barpos3(int&,char,int&,int&,int[][10],int[],int&,int&,int&,int&);
...
if(b1.mo==1)
{
		 ...
		 if(contro==2)
 		{
		     b1.barpos2(b1.mo,a,b1.concurs,contro,b1.pos,b1.bar1y,b1.bar1x,b1.ax1,b1.pox,b1.poy);
 		}
  		if(contro==3)
 		{
                    b1.barpos3(b1.mo,a,b1.concurs,contro,b1.pos,b1.bar1y,b1.bar1x,b1.ax1,b1.pox,b1.poy);
...
if(b1.mo==2)
{
                if(contro==1)
                {
                 ...
                 if(contro==2)
                {
                    b2.barpos2(b1.mo,a,b2.concurs,contro,b2.pos,b2.bar1y,b2.bar1x,b2.ax1,b2.pox,b2.poy);

                }
                if(contro==3)
                {
                    b2.barpos3(b1.mo,a,b2.concurs,contro,b2.pos,b2.bar1y,b2.bar1x,b2.ax1,b2.pox,b2.poy);
...
void batt::barpos1(int mo,char m,int &cur,int &contro,int pos[10][10],int bar1y[4],int &bar1x,int &ax1,int &pox,int &poy)
{
	if(m==119 or m==65)
        {  if(bar1y[0]>0)
	     {
...
void batt::barpos2(int mo,char m,int &cur,int &contro,int pos[10][10],int bar1y[4],int &bar1x,int &ax1,int &pox,int &poy)
...
void batt::barpos3(int &mo,char m,int &cur,int &contro,int pos[10][10],int bar1y[4],int &bar1x,int &ax1,int &pox, int &poy)
